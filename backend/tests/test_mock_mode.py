...
ROLE = "admin"  # роли по умолчанию разрешают все 21 инструментов
...
EXPECTED_MOCK_TOOLS = {
    ...
    "get_printers_report", "get_printers_pages_report",
}
...
def test_all_21_tools_registered():
    from app.agent.mock import MOCK_TOOLS
    assert set(MOCK_TOOLS.keys()) == EXPECTED_MOCK_TOOLS
    # Все 21 моков соответствуют реально зарегистрированным инструментам
